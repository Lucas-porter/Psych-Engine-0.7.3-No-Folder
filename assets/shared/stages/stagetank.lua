...
function onCreate()
	...
	scaleObject('tankRolling',2.0,2.0)
	...
	scaleObject('tankGround', 2.3, 2.3);
	...
	if not lowQuality then
		...
		scaleObject('tankClouds',2.0,2.0)
		...
		scaleObject('tankMountains', 2.4, 2.4);

		makeAnimatedLuaSprite('smokeLeft', 'tank/smokeLeft', -200, -100);
		scaleObject('smokeLeft',2.0,2.0)
		...
		scaleObject('smokeRight',2.0,2.0)
