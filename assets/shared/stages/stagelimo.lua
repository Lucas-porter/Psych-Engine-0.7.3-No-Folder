...
function onCreatePost()
	...
	runHaxeCode([[
	  var ulisegaswasherexd = new FlxBackdrop(Paths.image('limo/erect/mistBack'), 0x11, 0, 100);
	  ulisegaswasherexd.scale.set(2, 2);
	  ulisegaswasherexd.velocity.set(1500,0);
	  ulisegaswasherexd.blend=0;
	  ulisegaswasherexd.scrollFactor.set(1, 1);
	  ulisegaswasherexd.updateHitbox();
	  add(ulisegaswasherexd);

	  var nomerobenelportporfavormetomomuchotiempoynohedormidonada = new FlxBackdrop(Paths.image('limo/erect/mistMid'), 0x11, 0, 100);
	  nomerobenelportporfavormetomomuchotiempoynohedormidonada.scale.set(2, 2);
	  nomerobenelportporfavormetomomuchotiempoynohedormidonada.velocity.set(1500,0);
