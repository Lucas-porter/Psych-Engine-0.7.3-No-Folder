function onCreate()
	...
	makeLuaSprite('bg', 'christmas/erect/bgWalls', -1000, -500)
	...
	updateHitbox('bg')
		...
		scaleObject('upperBoppers', 2.0, 2.0);
		...
		scaleObject('bgEscalator', 4.0, 4.0);
	...
	makeAnimatedLuaSprite('bottomBoppers', 'christmas/erect/bottomBop', 260, 280)
